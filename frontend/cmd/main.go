// Package main is the entry point for the frontend service.
package main
...
func main() {
	...
	frontend.HandleFunc("GET /health", frontendApp.health)
	frontend.HandleFunc("GET /ready", frontendApp.ready)
